...
This project is based on the Author Kit boilerplate and set up as a new project. You are expected to follow the coding style and practices established in the boilerplate, but add functionality according to the needs of the site currently developed.
...
- Always use `await` instead of `.then()` in async JavaScript
- Always use defensive coding rules in JavaScript
